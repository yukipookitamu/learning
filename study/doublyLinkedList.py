'''
    ...
    My First Doubly Linked List

    This program is the basic doubly linked list data structure.
    This program contains a doubly linked list that has been heavily
